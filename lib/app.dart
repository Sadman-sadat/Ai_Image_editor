...
class _AIImageEditorState extends State<AIImageEditor> with WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    if (Get.isRegistered<AppLifecycleController>()) {
      Get.find<AppLifecycleController>().didChangeAppLifecycleState(state);
    }

    // Force rebuild the entire app when it resumes
